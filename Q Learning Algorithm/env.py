# File: env.py
# Description: Building the environment-1 for the turtle to explore
# Agent - turtle
...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.title('RL Q-learning. Sichkar Valentyn-Modif')
    ...
    def build_environment(self):
        ...
        # Obstacle type 1 - mp_tenda
        img_obstacle1 = Image.open("images/mp_tenda.png")
        self.obstacle1_object = ImageTk.PhotoImage(img_obstacle1)
        # Obstacle type 2 - mp_rumput 2
        img_obstacle2 = Image.open("images/mp_rumput 2.png")
        self.obstacle2_object = ImageTk.PhotoImage(img_obstacle2)
        # Obstacle type 3 - mp_kayu
        img_obstacle3 = Image.open("images/mp_kayu.png")
        self.obstacle3_object = ImageTk.PhotoImage(img_obstacle3)
        # Obstacle type 4 - mp_harimau
        img_obstacle4 = Image.open("images/mp_harimau.png")
        self.obstacle4_object = ImageTk.PhotoImage(img_obstacle4)
        # Obstacle type 5 - mp_batu
        img_obstacle5 = Image.open("images/mp_batu.png")
        self.obstacle5_object = ImageTk.PhotoImage(img_obstacle5)
        # Obstacle type 6 - mp_sampah 2
        img_obstacle6 = Image.open("images/mp_sampah 2.png")
        self.obstacle6_object = ImageTk.PhotoImage(img_obstacle6)
        # Obstacle type 7 - mp_sampah 
        img_obstacle7 = Image.open("images/mp_sampah.png")
        self.obstacle7_object = ImageTk.PhotoImage(img_obstacle7)
        # Obstacle type 8 - mp_rumah rz
        img_obstacle8 = Image.open("images/mp_rumah rz.png")
        self.obstacle8_object = ImageTk.PhotoImage(img_obstacle8)
        # Obstacle type 9 - mp_pohon 1
        img_obstacle9 = Image.open("images/mp_pohon 1.png")
        self.obstacle9_object = ImageTk.PhotoImage(img_obstacle9)
        # Obstacle type 12 - mp_pagar
        img_obstacle12 = Image.open("images/mp_pagar.png")
        self.obstacle12_object = ImageTk.PhotoImage(img_obstacle12)
        img_obstacle13 = Image.open("images/mp_panahatas.png")
        self.obstacle13_object = ImageTk.PhotoImage(img_obstacle13)
        img_obstacle14 = Image.open("images/mp_panah.png")
        self.obstacle14_object = ImageTk.PhotoImage(img_obstacle14)
        img_obstacle15 = Image.open("images/mp_panah kanan.png")
        self.obstacle15_object = ImageTk.PhotoImage(img_obstacle15)

        # Creating obstacles themselves
        # Obstacles from 1 to 29
        ...
        # Obstacle 4
        self.obstacle4 = self.canvas_widget.create_image(pixels * 2, pixels * 4, anchor='nw', image=self.obstacle2_object)
        # Obstacle 5
        self.obstacle5 = self.canvas_widget.create_image(pixels * 4, 0, anchor='nw', image=self.obstacle9_object)
        # Obstacle 6
        ...
        # Obstacle 8
        self.obstacle8 = self.canvas_widget.create_image(pixels * 6, pixels, anchor='nw', image=self.obstacle5_object)
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 5, pixels * 9, anchor='nw', image=self.obstacle12_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 3, pixels * 9, anchor='nw', image=self.obstacle12_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 5, pixels * 5, anchor='nw', image=self.obstacle4_object)
        # Obstacle 12
        ...
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 7, pixels * 9, anchor='nw', image=self.obstacle12_object)
        # Obstacle 18
        self.obstacle18 = self.canvas_widget.create_image(pixels, pixels * 6, anchor='nw', image=self.obstacle9_object)
        # Obstacle 19
        self.obstacle19 = self.canvas_widget.create_image(pixels * 9, pixels * 3, anchor='nw', image=self.obstacle8_object)
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 9, pixels * 9, anchor='nw', image=self.obstacle12_object)
        # Obstacle 21
        ...
        # Obstacle 23
        self.obstacle23 = self.canvas_widget.create_image(pixels * 3, pixels * 3, anchor='nw', image=self.obstacle2_object)
        # Obstacle 24
        self.obstacle24 = self.canvas_widget.create_image(pixels * 1, pixels * 9, anchor='nw', image=self.obstacle12_object)
        # Obstacle 25
        self.obstacle25 = self.canvas_widget.create_image(pixels * 8, pixels * 8, anchor='nw', image=self.obstacle9_object)
        # Obstacle 26
        self.obstacle26 = self.canvas_widget.create_image(pixels * 6, pixels * 5, anchor='nw', image=self.obstacle13_object)
        # Obstacle 27
        self.obstacle27 = self.canvas_widget.create_image(pixels * 7, pixels * 6, anchor='nw', image=self.obstacle15_object)
        # Obstacle 28
        self.obstacle28 = self.canvas_widget.create_image(pixels * 5, pixels * 6, anchor='nw', image=self.obstacle14_object)
        # Obstacle 29
        self.obstacle29 = self.canvas_widget.create_image(pixels * 7, pixels * 7, anchor='nw', image=self.obstacle4_object)
        ...
        # Uploading the image for Agent
        img_robot = Image.open("images/mp_kura agent.png")
        self.robot = ImageTk.PhotoImage(img_robot)

        # Creating an agent with photo of mp_kura agent
